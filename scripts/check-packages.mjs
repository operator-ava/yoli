...
// Пересчитано 22.08.2026 дважды: сперва food эконома 15 → 22 (третий приём
// пищи), затем добавлена статья «такси по городу» 8 / 12 / 25 — она подняла
// цену на всех трёх тарифах.
const EXPECT = {
  7: { 1: [1230, 1680, 2780], 2: [760, 1040, 1720], 12: [580, 790, 1310] },
  10: { 1: [1650, 2290, 3760], 2: [1030, 1420, 2330], 12: [780, 1080, 1770] },
  15: { 1: [2360, 3320, 5410], 2: [1470, 2060, 3350], 12: [1110, 1560, 2540] },
}
