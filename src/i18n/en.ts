...
export const en: Dict = {
  ...
  'service.routes.title': 'Curated routes',
  'service.routes.d1': 'Ready-made routes for the cities of the trip: the order of the points and the time for each.',
  'service.routes.d2': 'The number of routes is unlimited on every tariff, and the plan can be changed on the go.',
  'service.routes.note': 'The set of routes is confirmed before the booking is finalised.',
