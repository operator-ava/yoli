...
/* Заметка справа НИКОГДА не переносится на вторую строку.
   Перенос делал строку выше соседних, и три карточки переставали
   читаться как одна таблица: у люкса «Экскурсии» были 62 px против 46,
   а всё, что ниже, съезжало на 16 px. Не влезает — ужимается колонка
   названия, а не ломается высота строки. */
.item-note {
  font-size: 12px;
  text-align: right;
  white-space: nowrap;
